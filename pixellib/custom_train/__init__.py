...
class instance_custom_training:
    ...
    def load_customer_dataset(self, dataset):
        ...
        # Training dataset.
        self.dataset_train = Data()
        self.dataset_train.load_data(save_json_path1, labelme_folder1 + '/image')
        self.dataset_train.prepare()
        ...
        #conversion of individual labelme json files into a single json file  
        labelme2coco.labelme2coco_custom(labelme_folder2, save_json_path2)
        
        # Training dataset.
        self.dataset_test = Data()
        self.dataset_test.load_data(save_json_path2, labelme_folder2 + '/image')
        self.dataset_test.prepare()
        ...
        #conversion of individual labelme json files into a single json file  
        labelme2coco.labelme2coco_custom(labelme_folder3, save_json_path3)
        
        # Training dataset.
        self.dataset_val = Data()
        self.dataset_val.load_data(save_json_path3, labelme_folder3 + '/image')
